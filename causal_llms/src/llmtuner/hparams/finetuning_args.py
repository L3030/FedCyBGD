...
class FinetuningArguments:
    ...
    switch_mode: Optional[Literal["ascending", "descending", "random", "fixed", "agg", "adap", "lora", "full"]] = field(
        default="ascending",
        metadata={"help": "the strategy of picking block to update."}
    )
    finetuning_type: Optional[Literal["lora", "freeze", "full", "none", "block", "sparse", "flblock", "adap", "adap_lora", "cadap", "cadap_lora"]] = field(
        default="lora",
    ...
    num_clients: Optional[int] = field(
        default=32,
        metadata={"help": "The number of clients participate in FL BCD"}
    )
    bcd_epochs: Optional[int] = field(
        default=3,
        metadata={"help": "The communication rounds of FL BCD"}
    )
    sample_num: Optional[int] = field(
        default=2,
        metadata={"help": "how many clients sampled to train current block"}
    )
    power_sgd: bool = field(
        default=False,
        metadata={"help": "whether to use power-sgd"}
    )
    compress: Optional[float] = field(
        default=-1,
        metadata={"help": "how many clients sampled to train current block"}
    )
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "freeze", "full", "none", "block", "sparse", "flblock", "adap", "adap_lora", "cadap", "cadap_lora"], "Invalid fine-tuning method."
